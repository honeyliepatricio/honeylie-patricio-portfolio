  ...
  return (
    <section className="relative overflow-hidden bg-navy-900">
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle, rgba(248,245,239,0.08) 1px, transparent 1px)",
      ...
      <Container className="relative grid gap-12 py-16 md:py-24 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <div className="animate-fade-up">
          <p className="mb-5 text-sm font-medium uppercase tracking-wide text-gold-400">
            Registered Nurse → Virtual Assistant
          </p>
          <h1 className="text-4xl leading-[1.1] text-stone-50 md:text-5xl lg:text-[3.25rem]">
            Healthcare &amp; Operations Virtual Assistant
          </h1>
          <p className="mt-5 max-w-xl text-lg leading-relaxed text-stone-100/90">
            {site.tagline}
          </p>
          <p className="mt-4 max-w-xl text-base leading-relaxed text-stone-100/75">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <Button href="/experience" variant="outlineLight">
              View My Experience
            </Button>
          </div>
        </div>
